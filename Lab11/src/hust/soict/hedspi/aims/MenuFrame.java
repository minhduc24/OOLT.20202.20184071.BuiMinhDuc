...
import hust.soict.hedspi.aims.order.LuckyItemException;
...
public class MenuFrame extends JFrame {
    ...
    public MenuFrame(JFrame jFrame) {
        ...
        createThresholds.addActionListener(e -> new AddThresholds());
        ...
        deleteButton.addActionListener(e -> {
            if (anOrder != null) {
                String strid = JOptionPane.showInputDialog(null,"Enter id you want delete: ","Delete ID",JOptionPane.INFORMATION_MESSAGE);
                int id = Integer.parseInt(strid);
                if (anOrder.removeMedia(id)) {
